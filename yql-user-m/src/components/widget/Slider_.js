...
export default class SwipeSlider extends React.Component {
	...
	render(){
      ...
      return (
		<div className={classnames('swiper-container swiper-init', this.props.className)} ref="swiperContainer">
		  {
		  	this.props.children
	      ...
	      <div className="swiper-wrapper">
	      {
		      data.map( (banner, index) => (
		        <div className="swiper-slide" key={index} ><a href={banner.link} ><img className="slide-img" src={banner.url}/></a></div>
		      ))
	      }
